...
COLORS_ON = [color(0xFF0000),color(0xFF60AF),color(0xFF44FF),color(0xB15BFF),color(0x6A6AFF),color(0x2894FF),color(0x00FFFF),color(0x1AFD9C),color(0x28FF28),color(0x9AFF02),color(0xFFFF37),color(0xFFDC35),color(0xFF8000),color(0xFF5809),color(0xB87070),color(0xAFAF61),color(0x6FB7B7),color(0x9999CC),color(0xB766AD)]
COLORS_OFF = [color(0x000000),color(0x3C3C3C),color(0x5B5B5B),color(0x7B7B7B),color(0x9D9D9D),color(0xADADAD),color(0xE0E0E0),color(0xFCFCFC)
]
